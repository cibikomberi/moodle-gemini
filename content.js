	...
	function onWindowLoad() {
		...
		port.onMessage.addListener(function (msg) {
			...
			for (let i = 0; i < elements.length; i++) {
				var qtext = elements[i].innerText + elements1[i].innerText + " Send only the option with answer without explanation";
