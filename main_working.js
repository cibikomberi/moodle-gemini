...
for (let i = 0; i < elements.length; i++) {
  if (k.innerText === "Accurate") {
    ...
    async function run() {
      const prompt = "need the correct option with the whole answer and not explanation for " + p1 + p2;
    ...
    async function run() {
      const prompt ="need the correct option with the whole answer and not explanation for " +  textContent + textContent1;
