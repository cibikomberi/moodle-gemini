...
if (elements1.length) {
	elements1[elements1.length - 1].insertAdjacentElement('afterend', butt);
}
...
for (let i = 0; i < elements.length; i++) {
	if (k.innerText === "Accurate") {
		...
		async function run() {
			...
			output.style.padding = "5px";
			output.style.fontFamily = "Roboto";
			elements[i].insertAdjacentElement('afterend', output);
			...
			out.style.padding = "10px";
			out.style.backgroundColor = "#131314";
			out.style.borderTopLeftRadius = "7px";
			out.style.borderTopRightRadius = "7px";
			output.appendChild(out);

			var outVal = document.createElement("DIV");
			outVal.style.backgroundColor = "#282A2C";
			outVal.style.padding = "10px";
			outVal.style.borderBottomLeftRadius = "7px";
			outVal.style.borderBottomRightRadius = "7px";
